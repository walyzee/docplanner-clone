...
const navMenu = {
  logo:require('./ressources/header-logo.svg'),
  items:[
    {link:'#',title:'About us',isActive : true},
    {link:'#',title:'Career',isActive : false},
    {link:'#',title:'Departments',isActive : false,children:[
      {link:'#',title:'marketing & PR',isActive : false},
      {link:'#',title:'customer success and sales',isActive : false},
      {link:'#',title:'IT, Product, design & UX, data',isActive : false},
      {link:'#',title:'finance & administration',isActive : false},
      {link:'#',title:'HR & more',isActive : false}
    ]}
  ]
}

const presentationContent={
  logo:require('./ressources/sygnet.png'),
  title:'Making the healthcare experience more human',
  leftParagraph:'We want patients to find the perfect doctor and book an appointment in the most easy way.The patient journey should be enjoyable, and that\'s why we are always next to them: to help them find the best possible care.Anytime, anywhere.',
  rightParagraph:'We also help doctors to better manage their practice and build their online reputation. With our integrated end-to-end solution, doctors are able not only to improve their online presence, but also to devote their time to what really matters: their patients.',
  cards:[
    {
      class:'patients-bloc',
      title:'For patients',
      about:'Find a doctor, book a visit and solve any health-related doubt',
      selectBox:[
        {content:'CHOOSE COUNTRY', value:'country'},
        {content:'Argentina', value:'argentina'},
        {content:'Australia', value:'australia'},
        {content:'Brasil', value:'brasil'}
      ],
      image:require('./ressources/screen-marketplace.png')
    },
    {
      class:'doctors-bloc',
      title:'For doctors',
      about:'Save time managing visits and cut no-shows by half',
      image:require('./ressources/screen-saas.png')
    }
  ]
}
...
const statsContent={
  ...
  about:'We work from 6 offices all over the world, bringing Docplanner Group to life in almost 20 countries.',
  bgImage:require('./ressources/logo.png'),
  cards:[
    {icon:require('./ressources/flag.png') ,title:'Leader in 10 countries',content:'Poland, Turkey, Spain, Italy, Czech Republic, Mexico, Brazil, Colombia, Argentina and Chile'},
    {icon:require('./ressources/visits.png'),title:'1.5 million appointments',content:'booked last month'},
    {icon:require('./ressources/patients.png'),title:'30 million unique patients',content:'visit us every month'},
    {icon:require('./ressources/doctors.png'),title:'2 million active doctors',content:'trust in our solutions'}
  ]
}

const placesContent={
  title:'Improve the lives of millions.\nChange yours forever',
  about:'More than 1000 team mates share our same vision, goals and passion.\nWith offices in Warsaw, Barcelona, Istanbul, Rome, Mexico City and\nCuritiba, our search for great talent never stops.',
  cards:[
    {image:require('./ressources/warsaw.png'),title:'Warsaw',link:'https://www.docplanner.com/career?&loc=poland#jobs-offers'},
    {image:require('./ressources/barcelona.png'),title:'Barcelona',link:'https://www.docplanner.com/career?&loc=spain#jobs-offers'},
    {image:require('./ressources/istanbul.png'),title:'Istanbul',link:'https://www.docplanner.com/career?&loc=rome#jobs-offers'},
    {image:require('./ressources/rome.png'),title:'Rome',link:'https://www.docplanner.com/career?&loc=italy#jobs-offers'},
    {image:require('./ressources/mexico-city.png'),title:'Mexico City',link:'https://www.docplanner.com/career?&loc=mexico#jobs-offers'},
    {image:require('./ressources/curitiba.png'),title:'Curitiba',link:'https://www.docplanner.com/career?&loc=brazil#jobs-offers'}
  ]
}

const footerContent={
  about:'We are leaders in 10 countries : ',
  locations:[
    {title:'Poland',link:'https://www.znanylekarz.pl/?_ga=2.103317376.127968892.1585572493-1304678231.1583531626'},
    {title:'Turkey',link:'https://www.doktortakvimi.com/?_ga=2.36427680.127968892.1585572493-1304678231.1583531626'},
    {title:'Spain',link:'https://www.doctoralia.es/'},
    {title:'Italy',link:'https://www.miodottore.it/?_ga=2.36427680.127968892.1585572493-1304678231.1583531626'},
    {title:'Czech Republic',link:'https://www.znamylekar.cz/'},
    {title:'Mexico',link:'https://www.doctoralia.com.mx/'},
    {title:'Colombia',link:'https://www.doctoralia.co/'},
    {title:'Brazil',link:'http://www.doctoralia.com.br/'},
    {title:'Argentina',link:'http://www.doctoraliar.com/'},
    {title:'Chile',link:'http://www.doctoralia.cl/'}
  ],
  cookies:'This site uses cookies to deliver services in accordance with this Privacy Policy. You can specify the conditions for storing or accessing cookies on your browser.',
...
const App = () =>
  <div>
    ...
    <Branch branchs={branchsContent} />
    <Stats stats={statsContent}/>
    <Place places={placesContent}/>
